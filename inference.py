...
def parse_args() -> Namespace:
    ...
    # Model arguments.
    parser.add_argument("-psm", "--path_segmentation_model", default="models/SegForCoralBig-2025_05_14_25188-bs16_coarse_b2", help="Path to semgentation model, currently only in local.")
